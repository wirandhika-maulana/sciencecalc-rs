...
impl Balok {
    ...
    pub fn keliling(&self) -> f64 {
        4.0 * (self.panjang + self.lebar + self.tinggi)
    }
    ...
    pub fn diagonal_bidang(&self) -> f64 {
        (self.panjang.powi(2) + self.lebar.powi(2)).sqrt()
    }
...
impl Bola {
    ...
    pub fn luas_permukaan(&self) -> f64 {
        4.0 * std::f64::consts::PI * self.r.powi(2)
    }
    pub fn keliling(&self) -> f64 {
        2.0 * std::f64::consts::PI * self.r
    }
    pub fn setengah_volume(&self) -> f64 {
        (2.0 / 3.0) * std::f64::consts::PI * self.r.powi(3)
    }
}
...
impl Tabung {
    ...
    pub fn luas_permukaan(&self) -> f64 {
        2.0 * std::f64::consts::PI * self.r * (self.r + self.tinggi)
    }
...
impl Kerucut {
    pub fn new(r: f64, tinggi: f64) -> Self { Self { r, tinggi } }
    pub fn volume(&self) -> f64 {
        (1.0 / 3.0) * std::f64::consts::PI * self.r.powi(2) * self.tinggi
    }
    pub fn luas_alas(&self) -> f64 {
        std::f64::consts::PI * self.r.powi(2)
    }
    ...
    pub fn luas_selimut(&self) -> f64 {
        std::f64::consts::PI * self.r * self.garis_pelukis()
    }
}
...
impl LimasSegitiga {
    ...
    pub fn luas_permukaan(&self) -> f64 {
        ...
        let luas_sisi_tegak: f64 = self.sisi_tegak.iter().map(|(a, t)| 0.5 * a * t).sum();
...
impl LimasPersegi {
    ...
    pub fn volume(&self) -> f64 {
        (1.0 / 3.0) * (self.panjang_alas * self.lebar_alas) * self.tinggi
    }
    pub fn luas_alas(&self) -> f64 {
